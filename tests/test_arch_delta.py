...
class TestArchDeltas(unittest.TestCase):
    ...
    def test_init_and_load(self):
        ...
        init_deltas(self.tmpdir, "triton", "abc123", "2026-08-01T00:00:00")
        data = load_deltas(self.tmpdir, "triton")
    ...
    def test_add_delta(self):
        ...
        init_deltas(self.tmpdir, "triton", "abc123", "2026-08-01T00:00:00")
        add_delta(self.tmpdir, "triton", "def456", {
        ...
        delta = get_delta(self.tmpdir, "triton", "def456")
    ...
    def test_get_deltas_since_baseline(self):
        ...
        init_deltas(self.tmpdir, "triton", "abc123", "2026-08-01T00:00:00")
        add_delta(self.tmpdir, "triton", "def456", {"change_summary": "c1", "ascend_impact": False})
        add_delta(self.tmpdir, "triton", "ghi789", {"change_summary": "c2", "ascend_impact": True})

        baseline, deltas = get_deltas_since_baseline(self.tmpdir, "triton")
    ...
    def test_get_deltas_up_to(self):
        ...
        baseline, deltas = get_deltas_up_to(self.tmpdir, "triton", "def456")
    ...
    def test_reset_deltas(self):
        ...
        init_deltas(self.tmpdir, "triton", "abc123", "2026-08-01T00:00:00")
        add_delta(self.tmpdir, "triton", "def456", {"change_summary": "c1"})
        self.assertEqual(delta_count(self.tmpdir, "triton"), 1)

        reset_deltas(self.tmpdir, "triton", "new123", "2026-08-02T00:00:00")
        self.assertEqual(delta_count(self.tmpdir, "triton"), 0)

    def test_get_affected_commits(self):
        from data._track_arch_delta import init_deltas, add_delta, get_affected_commits

        init_deltas(self.tmpdir, "triton", "abc123", "2026-08-01T00:00:00")
        add_delta(self.tmpdir, "triton", "def456", {"ascend_impact": False})
        add_delta(self.tmpdir, "triton", "ghi789", {"ascend_impact": True})

        affected = get_affected_commits(self.tmpdir, "triton")
